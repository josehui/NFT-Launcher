    ...
    <>
      ...
      <Container maxW={'3xl'}>
        <Stack
          ...
          <Text color={'gray.500'}>
            Why work 9-6 when you an be rich by uploading images to blockchain? <br />
            NFT Launcher lets you launch NFT and earn <s>scam</s> money with 0 effort,
            0 creativity and 0 knowledge
          </Text>
          <Stack
            direction={'column'}
            spacing={3}
